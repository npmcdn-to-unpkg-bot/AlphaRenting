                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="panel panel-login">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <form runat="server" id="loginform" method="post" style="display: block;">
                                            <asp:FormView runat="server" ID="fvConnexion" DefaultMode="Insert">
                                                <InsertItemTemplate>
                                                    <div style="margin-bottom: 25px" class="input-group">
                                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                                        <asp:TextBox runat="server" CssClass="form-control" ID="txtMail" Text="adresse mail" />
                                                    </div>
                                                    <div style="margin-bottom: 25px" class="input-group">
                                                        <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                                                        <asp:TextBox runat="server" CssClass="form-control" TextMode="Password" ID="txtPassword" Text="Mot de Passe" />
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-sm-6 col-sm-offset-3">
                                                                <asp:Button runat="server" CssClass="form-control btn btn-login" ID="btnSubmit" OnClick="btnSubmit_Click" Text="Connexion" />
