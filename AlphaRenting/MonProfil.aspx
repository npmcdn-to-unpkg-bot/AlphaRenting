                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="text-center">
                                    <asp:Image runat="server" CssClass="avatar img-circle" ImageUrl='<%# Eval("Photo")  %>' />
                            ...
                            <div class="col-md-9 personal-info">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <asp:TextBox runat="server" ID="txtPasswordconf" CssClass="form-control" TextMode="Password"></asp:TextBox>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <asp:TextBox runat="server" CssClass="form-control" ID="txtMail" Text='<%# Eval("Mail") %>' TextMode="Email"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <asp:Button runat="server" CssClass="btn btn-primary navbar-btn nevButt" ID="btnClick" CommandName="insert" />
                                        </div>
                                    </div>
                                </div>
                            </div>
